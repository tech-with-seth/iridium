...
export default function DesignRoute({ actionData }: Route.ComponentProps) {
    ...
    return (
        <Container className="flex flex-col gap-12 py-8 px-4">
            ...
            <div className="grid grid-cols-2 gap-8">
                ...
                <section className="flex h-full flex-col gap-4">
                    ...
                    <Code
                        ...
                        lines={[
                            { content: '<HoverCard>' },
                            {
                                content: '  <figure className="rounded-box">',
                            },
                            {
                                content:
                ...
                <section className="flex h-full flex-col gap-6">
                    ...
                    <Code
                        ...
                        lines={[
                            {
                                content: '<Tooltip tip="Hello" position="top">',
                            },
                            { content: '  <Button>Hover me</Button>' },
                            { content: '</Tooltip>' },
                        ]}
            ...
            <Alert status="success">
                <div>
                    <h3 className="font-bold">Looking for more components?</h3>
                    <div className="text-xs">
                        Explore the complete DaisyUI component library and usage
                        guidelines at:
                        <a
